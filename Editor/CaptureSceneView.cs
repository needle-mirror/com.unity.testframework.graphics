...
namespace UnityEditor.TestTools.Graphics
{
    ...
    public class CaptureSceneView
    {
        ...
        public static IEnumerator CaptureFromMainCamera(int sceneViewWidth = 512, int sceneViewHeight = 512, int delayBeforeCapture = 100)
        {
            yield return Capture(Camera.main, sceneViewWidth, sceneViewHeight, delayBeforeCapture);
        }
        ...
        /// <param name="delayBeforeCapture"> The delay between setting up the camera and capturing. Defaults to 100. </param>
        /// <returns> an IEnumerator to yield return to UnityTests </returns>
        public static IEnumerator Capture(Camera imageComparisonViewpoint, int sceneViewWidth = 512, int sceneViewHeight = 512, int delayBeforeCapture = 100)
        {
