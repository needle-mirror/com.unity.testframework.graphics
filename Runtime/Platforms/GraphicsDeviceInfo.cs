...
namespace UnityEngine.TestTools.Graphics.Platforms
{
    ...
    public static class GraphicsDeviceInfo
    {
        ...
        /// <summary>
        /// Whether the current device supports compute shaders.
        /// </summary>
        /// <remarks>
        /// This is a boolean that returns true on devices which support compute shaders. See <see cref="SystemInfo.graphicsShaderLevel"/> for more information.
        /// </remarks>
        ...
        public static bool IsVersionAtLeast(string version) =>
            string.Compare(Version, version, StringComparison.Ordinal) >= 0;

        /// <summary>
        /// Returns a string representation of the current graphics device information.
        /// </summary>
        /// <returns>A string representation of the current graphics device information</returns>
